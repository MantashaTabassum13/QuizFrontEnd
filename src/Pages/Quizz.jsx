...
function Quizz() {
    ...
    // Shuffle and select 5 random questions from QuizData
    useEffect(() => {
        const shuffledData = shuffleArray(QuizData).slice(0, 5);
    ...
    const updateScore = () => {
        if (clickedOption === QuizData.findIndex((question) => question === shuffledQuestions[currentQuestionIndex])) {
            setScore(score + 1);
        }
    };
